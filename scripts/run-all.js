...
const updateDisplayedLog = () => {
	...
	process.stdout.write(
		c`$[bg-white]$[bold]$[black] Controls: $[reset] $[bold]$[red]q$[reset]: quit${'     '}$[bold]$[green]n$[reset]: next${'     '}$[bold]$[blue]p$[reset]: previous${'     '}$[bold]$[yellow]r$[reset]: refresh${'     '}Current:$[bold]$[cyan]${
